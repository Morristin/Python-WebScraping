...
class DatabaseOperationTestCase(unittest.TestCase):
    def testBasicOperation(self):
        ...
        manager.add_good(GoodManager.Good('Test Item', 9.9, dt.datetime.now(), 'Amazon', 'test-href'))
        manager.add_good(
            GoodManager.Good('中国制造设备', 8.8, dt.datetime.fromisoformat('2000-12-11 12:11'), 'WTO', 'test-href'))
